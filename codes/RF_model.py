...
def model(features):
    RF_model = RFR(n_estimators=60, oob_score=True, max_depth=6, random_state=0)
    ...
    utils.plot_feature_importance(RF_model.feature_importances_, features, "RF")
    print("Predicted results: {}".format(list(RF_model.predict(x_test))))
...
if __name__ == "__main__":
    ...
    samples.to_csv("../data/predicted_result_RF.csv", index=False)
